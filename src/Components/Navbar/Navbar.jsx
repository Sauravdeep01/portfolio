    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/Sauravdeep01"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/saurav-deep-1b2853298/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
      ...
      {isOpen && (
        <div
          ...
          bg-[#050414] bg-opacity-50 backdrop-blur-lg z-50 rounded-lg shadow-lg"
        >
